...
angular.module('angularApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/cart/confirm.html',
    ...
    "            <i class=\"card-paypal card-ico\"></i> Paypal\n" +
    "          </span>\n" +
    "          <span ng-if=\"!payPaypal\">\n" +
    ...
    "      <br />\n" +
    "      <fieldset>\n" +
    "        <legend ng-hide=\"!promoapplied\" translate>cart.recap.promo</legend>\n" +
    "        <legend ng-show=\"!promoapplied\" ng-click=\"askPromoCode()\" translate>cart.recap.use_promo</legend>\n" +
    "        <div class=\"form-group\" ng-hide=\"!promoapplied\">\n" +
    "          <div class=\"input-container\">\n" +
  ...
  $templateCache.put('views/cart/payment-list.html',
    ...
    "      <i class=\"picto-arrow-right\"></i>\n" +
    "    </a>\n" +
    "    <a ng-click=\"usePaypal()\" class=\"item item-add text-content\">\n" +
    "      <i class=\"picto-paypal\"></i>\n" +
    "      <span>{{'cart.use_paypal'|translate}}</span>\n" +
    "      <span class=\"text-description\" translate>cart.paypal.text</span>\n" +
    "    </a>\n" +
    "    <a ui-sref=\"app.cart.payment.add\" class=\"item item-add text-content\">\n" +
    "      <i class=\"picto-plus\"></i>\n" +
    "      <span>{{'cart.payment.add'|translate}}</span>\n" +
    "      <span class=\"text-description\" translate>cart.card.text</span>\n" +
    "    </a>\n" +
    "  </div>\n" +
  ...
  $templateCache.put('views/store/product.html',
    ...
    "      </div>\n" +
    "      <div ng-hide=\"oos\" class=\"add-to-cart\"><input type=\"submit\" ng-value=\"'product.add'|translate\"/></div>\n" +
    "      <div ng-show=\"oos\" class=\"add-to-cart\">\n" +
    "          <div class=\"alert alert-danger\" translate>error.out_of_stock</div>\n" +
    "      </div>\n" +
...
angular
  ...
  .config(function ($translateProvider) {
    ...
    "cart.recap.use_promo": "Utiliser un code promo",
    ...
    "cart.ask_promo": "Merci d'entrer votre code promotionnel",
...
angular
  ...
  .config(function ($translateProvider) {
    ...
    "cart.payment.add": "Bezahlen mit Kreditkarte",
    ...
    "cart.use_paypal": "Zahlen mit Paypal",
 ...
 */
angular.module('angularApp')
  .controller('SuccessCtrl', function ($scope, LocalStorage, User, order, $translate, Utils, $state, $stateParams, Cart, $timeout) {
  ...
  .controller('CartConfirmCtrl', function ($scope, User, $state, Cart, LocalStorage, Utils, $cookies, $translate, Lang, $window, $http) {
    ...
    var paypalPayment = function(){
      $scope.loading = true;
        ...
        $http.post(url + '/paypal.php?action=process&store=' + data.store + '&_=' + (new Date).getTime(), data)
            .then(function(response) {
